...
async function setupDatabase() {
    try {
        // Kết nối database
        await mongoose.connect('mongodb+srv://nguyenphuc29092004_db_user:6Nse3CR8NZQ2YLjV@cluster0.eqxaamj.mongodb.net/NNPTUD-C6?retryWrites=true&w=majority&appName=Cluster0');
